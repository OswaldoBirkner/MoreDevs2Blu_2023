...
import ravin.enumeradores.*;
import ravin.enumeradores.TipoProduto;
import ravin.modelos.*;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (executando){
            ...
            switch (opcaoSelecionada){
                ...
                default:
                JOptionPane.showMessageDialog(null, "You cego man?");
            }
        }
    ...
    public static Cliente cadastrarCliente() {
        ...
        cliente.setVip(
                Boolean.parseBoolean(JOptionPane.showInputDialog("O cliente é VIP? \n 0 - Não \n 1 - Sim]")));
